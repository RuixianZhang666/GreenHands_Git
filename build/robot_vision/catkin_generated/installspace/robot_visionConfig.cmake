...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_vision' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zrxlovedjl/cv_ws/install/${idir}'.  Ask the maintainer 'zrxlovedjl <zrxlovedjl@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zrxlovedjl/cv_ws/install/lib;/home/zrxlovedjl/cv_ws/devel/lib;/opt/ros/indigo/lib)
