...
if("TRUE" STREQUAL "TRUE")
  set(opencv_test_SOURCE_PREFIX /home/zrxlovedjl/cv_ws/src/opencv_test)
  set(opencv_test_DEVEL_PREFIX /home/zrxlovedjl/cv_ws/devel)
  ...
  set(opencv_test_INSTALL_PREFIX /home/zrxlovedjl/cv_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'opencv_test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'zrxlovedjl <zrxlovedjl@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'opencv_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zrxlovedjl/cv_ws/src/opencv_test/${idir}'.  Ask the maintainer 'zrxlovedjl <zrxlovedjl@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zrxlovedjl/cv_ws/devel/lib;/opt/ros/indigo/lib)
